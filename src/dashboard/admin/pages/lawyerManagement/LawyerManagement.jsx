...
const LawyerManagement = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const response = await axiosSecure.post("/add-lawyer", finalFormData);
      ...
      if (response.data.insertedId) {
        ...
        toast.error(
          response.data.message || "Failed to add lawyer. Please try again.",
        );
      }
    } catch (error) {
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-4 mb-8">
          ...
          <div className="bg-white rounded-xl p-4 shadow-lg border border-green-100">
            <div className="text-2xl font-bold text-green-600">
              {filteredLawyers.filter((l) => l.experience >= 5).length}
            </div>
            <div className="text-gray-600 text-sm">Experienced (5+ years)</div>
          </div>
        ...
        {searchTerm && (
          <div className="mb-6 p-4 bg-blue-50 rounded-xl border border-blue-200">
            <p className="text-blue-700">
              ...
              {filteredLawyers.length === 0 && " - No lawyers found"}
            </p>
          </div>
        )}
        ...
        {filteredLawyers.length === 0 ? (
          <div className="text-center py-12">
            ...
            <h3 className="text-xl font-semibold text-gray-600 mb-2">
              {searchTerm ? "No Lawyers Found" : "No Lawyers Found"}
            </h3>
