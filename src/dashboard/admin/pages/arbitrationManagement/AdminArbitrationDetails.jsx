          ...
          <div className="bg-white rounded-lg shadow border border-gray-200 p-6">
            ...
            <div className="space-y-4">
              ...
              <div>
                ...
                <p className="text-gray-800">{arbitration.caseCategory}</p>
              </div>
              <div>
                <label className="text-sm font-medium text-gray-500 block mb-1">
                  Dispute Nature
                </label>
                <p className="text-gray-800">{arbitration.disputeNature}</p>
              </div>
            </div>
          </div>
          ...
          <div className="bg-white rounded-lg shadow border border-gray-200 p-6">
            ...
            <div className="space-y-3">
              ...
              {arbitration.arbitration_status === "Pending" && (
                <button
                  onClick={() =>
                    navigate(`/admin/arbitrations/${arbitration._id}/update`, {
                      state: { arbitration },
                    })
                  }
              ...
              <button
                onClick={() =>
                  navigate(`/admin/arbitrations/${arbitration._id}/documents`, {
                    state: { arbitration },
                  })
                }
        ...
        <div className="mt-8 bg-white rounded-lg shadow border border-gray-200 p-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <div>
              ...
              <p className="text-gray-800 font-mono">{arbitration._id}</p>
            </div>
            <div>
              <label className="text-sm font-medium text-gray-500 block mb-1">
                Last Updated
              ...
              <p className="text-gray-800">
                {formatDate(
                  arbitration.updatedAt || arbitration.submissionDate,
                )}
              </p>
            </div>
            <div>
